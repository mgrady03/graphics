...
void createSphere(float radius, int numSegments) {
    ...
    numSphereVertices = static_cast<int>(vertices.size() / 3);
...
void init() {
    ...
    createSphere(1.0f, 50); // Adjust the radius and number of segments as needed
}
